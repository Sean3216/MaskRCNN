...
class MaskRCNNTrainer:
    def __init__(
        ...
        self.maskrcnn_mod = get_maskrcnn_model(num_classes=num_classes,pretrained = use_pretrained).to(self.device)
    ...
    def train(self, trainloader, epochs=100, print_every=10):
        ...
        for epoch in range(epochs):
            ...
            for b, (images, targets) in loop:
                ...
                loss_dict = self.maskrcnn_mod(images, targets)
