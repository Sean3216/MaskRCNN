...
│   └── data.yaml --> Should follow Ultralytics formating. Refer to the current data.yaml provided <Currently not used but will be used in the future for modularity>
├── eval/
│   └── utils.py
├── data.py
├── losses.py
